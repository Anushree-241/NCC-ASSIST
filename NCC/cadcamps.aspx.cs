...
public partial class NCC_cadcamps : System.Web.UI.Page
{
    SqlConnection con;
    SqlConnection con1;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                ...
                {
                    HyperLink updatt = (row.Cells[11].FindControl("HyperLink1") as HyperLink);
                ...
                else if (sd > DateTime.Today.Date)
                {
                    ...
                    HyperLink updatt = (row.Cells[11].FindControl("HyperLink1") as HyperLink);
                    HyperLink editatt = (row.Cells[12].FindControl("HyperLink2") as HyperLink);
    ...
    private void GridUpdateAndEdit()
    {
        ...
        {
            HyperLink updatt = (row.Cells[11].FindControl("HyperLink1") as HyperLink);
            string cmpid = row.Cells[0].Text;
            SqlCommand commandToCheckc_campid = new SqlCommand("select campid  from campatt where campid=" + "'" + cmpid + "'", con);
            con.Open();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow row in GridView1.Rows)
        {
            ...
            dr["CAMP NAME"] = GridView1.Rows[i].Cells[1].Text;
            dr["DESCRIPTION"] = GridView1.Rows[i].Cells[2].Text;
            dr["START DATE"] = GridView1.Rows[i].Cells[3].Text;
            dr["END DATE"] = GridView1.Rows[i].Cells[4].Text;
            dr["DURATION"] = GridView1.Rows[i].Cells[5].Text;
            dr["TYPE"] = GridView1.Rows[i].Cells[6].Text;
            dr["LOCATION"] = GridView1.Rows[i].Cells[7].Text;
            dr["PURPOSE"] = GridView1.Rows[i].Cells[8].Text;
            dr["FIRING"] = GridView1.Rows[i].Cells[9].Text;
            dr["CAMP FEES"] = GridView1.Rows[i].Cells[10].Text;
            dt.Rows.Add(dr);
