<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewrankholders.aspx.cs" Inherits="NCC_viewrankholders" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="content">
            ...
            <center>
                ...
                <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged">
                    ...
                    <asp:ListItem>Clear Options</asp:ListItem>
                ...
                <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                     <asp:ListItem selected="True"  hidden value="Choose Rank" > Choose Rank </asp:ListItem>
                            <asp:ListItem>Clear Options</asp:ListItem>
        ...
        <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" AutoGenerateColumns="False" DataKeyNames="r_id"  >
            <Columns>
                <asp:BoundField DataField="r_id" HeaderText="SL NO." InsertVisible="False" ReadOnly="True" SortExpression="r_id" />
                <asp:BoundField DataField="r_cfname" HeaderText="FIRST NAME" SortExpression="r_cfname" />
                <asp:BoundField DataField="r_clname" HeaderText="LAST NAME" SortExpression="r_clname" />
                <asp:BoundField DataField="r_c_fathersname" HeaderText="FATHER'S NAME" SortExpression="r_c_fathersname" />
                <asp:BoundField DataField="r_course" HeaderText="COURSE" SortExpression="r_course" />
                <asp:BoundField DataField="r_courseyear" HeaderText="COURSE YEAR" SortExpression="r_courseyear" />
                <asp:BoundField DataField="r_c_batch" HeaderText="BATCH" SortExpression="r_c_batch" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [rankholders]"></asp:SqlDataSource>
