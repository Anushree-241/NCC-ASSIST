<%@ Page Language="C#" AutoEventWireup="true" CodeFile="eventopenfolders.aspx.cs" Inherits="NCC_eventopenfolders" %>
...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Event Pictures</li>
  </ol>
</nav>
        </div>
        <center>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM eventpictures,eventgallery WHERE eventgallery.a_id = eventpictures.a_id and  eventpictures.a_id = @a_id">
            <SelectParameters>
