...
public partial class NCC_openfolders : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        string s = "select * from photogallery where a_id=" + "'" + Label1.Text + "'";
        ...
        if (imgext == ".jpg" || imgext == ".png" || imgext == ".jpeg")
        {
            ...
            Response.Write("<script>alert('Photo Added Successfully!!!');window.location='picsfolder.aspx';</script>");
