<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadevents.aspx.cs" Inherits="NCC_cadevents" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content">
            ...
            <div>
                ...
                <asp:Label ID="Label2" runat="server" Text="SORT BY EVENT TYPE"></asp:Label>
            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" >
                <asp:ListItem Selected="True" Hidden="hidden" Value="0">Choose Event type</asp:ListItem>
            ...
            <asp:GridView ID="GridView1"  runat="server" CellPadding="4" AutoGenerateColumns="False" Height="464px" Width="1182px" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px">
            <Columns>
                ...
                <%--<asp:TemplateField HeaderText="Image">
                    <ItemTemplate>
                        <img src="~/NCC/Uploades/Events photos/<%#Eval("event_photos")%>" height="100" width="100" />
                    </ItemTemplate>
                </asp:TemplateField>--%>
                <asp:BoundField DataField="event_amount" HeaderText="Event Fee" />
                <asp:TemplateField HeaderText="ATTENDANCE" >
                    <ItemTemplate >
                        
                        <asp:HyperLink CssClass="attbtn" Enabled="true" ID="HyperLink1" NavigateUrl='<%# String.Format("eventattendance.aspx?name={0}&d={1}&t={2}&ty={3}&id={4}", Eval("event_name"), Eval("event_date"), Eval("event_time"),Eval("event_type"),Eval("event_id")) %>' runat="server">UPDATE ATTENDANCE</asp:HyperLink>
                ...
                <asp:TemplateField HeaderText="EDIT" >
                    <ItemTemplate >
                        ...
                        <asp:HyperLink CssClass="edtbtn" Enabled="true" ID="HyperLink2" NavigateUrl='<%# String.Format("editeventattendance.aspx?name={0}&d={1}&t={2}&ty={3}&id={4}", Eval("event_name"), Eval("event_date"), Eval("event_time"),Eval("event_type"),Eval("event_id")) %>' runat="server">
