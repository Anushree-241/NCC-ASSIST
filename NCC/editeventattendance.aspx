<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editeventattendance.aspx.cs" Inherits="NCC_editeventattendance" %>
...
<body>
    ...
    <div class="card mt-3 border-4"  >
     ...
     <center>    <form id="form1" runat="server" class="row gx-2 gy-0 align-items-center">
       ...
       <div>
           ...
           <br /><br /><br />
           <asp:GridView ID="GridView1" runat="server" Caption="EDIT EVENT ATTENDANCE" CaptionAlign="top" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#3366CC" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" HorizontalAlign="Center" >
               <Columns>
                   ...
                   <asp:TemplateField HeaderText="ATTENDANCE STATUS" >
                       <ItemTemplate >
                           <asp:CheckBox ID="CheckBox1" Checked="false" runat="server" Text='<%#Eval("att_status")%>' />
                       </ItemTemplate>
                   </asp:TemplateField>
               </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select cadetid,appno,c_fname,c_lname,event_name,event_date,att_status from eventatt,cadet,event where eventatt.cadetid = cadet.cid and eventatt.eventid=@event_id and event.event_name=@event_name  ">
        <SelectParameters>
            <asp:QueryStringParameter Name="event_id" QueryStringField="id" />
            <asp:QueryStringParameter Name="event_name" QueryStringField="name" />
        </SelectParameters>
    </asp:SqlDataSource>
   </div>
    </div> 
