<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadcampreimbuse.aspx.cs" Inherits="NCC_cadcampreimbuse" %>
            ...
            <div>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                    <Columns>
                        ...
                        <asp:BoundField DataField="camp_amount" HeaderText="CAMP AMOUNT" SortExpression="camp_amount" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select appno,c_fname,c_mname,c_lname,c_course,c_courseyear,c_batch,camp_name,camp_amount,amt_reimburst from cadet,camp,campreimbursement where cadet.appno=campreimbursement.cadet_regid and camp.camp_id=campreimbursement.camp_id"></asp:SqlDataSource>
