<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadeventreimbuse.aspx.cs" Inherits="NCC_cadeventreimbuse" %>
...
<body>
    <form id="form1" runat="server">
       ...
       <center>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select appno,c_fname,c_mname,c_lname,c_course,c_courseyear,c_batch,event_name,amt_reimburst from cadet,event,eventreimbursement where cadet.appno = eventreimbursement.cadet_regid and event.event_id=eventreimbursement.event_id"></asp:SqlDataSource>
