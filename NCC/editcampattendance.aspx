<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editcampattendance.aspx.cs" Inherits="NCC_editattendance" %>
...
<body>
    ...
    <div class="card mt-3 border-4"  >
     ...
     <center>    <form id="form1" runat="server" class="row gx-2 gy-0 align-items-center">
       ...
       <div>
           ...
           <br />
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Caption="ATTENDANCE" CaptionAlign="Top" BackColor="White" BorderColor="#3366CC" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" HorizontalAlign="Center" >
               <Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select cadetid,appno,c_fname,c_lname,camp_name,camp_startingdate,att_status from campatt,cadet,camp where campatt.cadetid = cadet.cid and campatt.campid=@camps_id and camp.camp_name=@camp_name  ">
        <SelectParameters>
            <asp:QueryStringParameter Name="camps_id" QueryStringField="id" />
            <asp:QueryStringParameter Name="camp_name" QueryStringField="name" />
        </SelectParameters>
    </asp:SqlDataSource>
