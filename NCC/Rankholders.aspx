<%@ Page Language="C#" AutoEventWireup="true" Debug="true" CodeFile="Rankholders.aspx.cs" Inherits="NCC_Rankholders" %>
...
<body>
    <form id="form1" runat="server">
        <div class="wrapper "  >
        <!-- Sidebar  -->
        <nav id="sidebar"  style="background-color:#22395D;position:sticky;" >
        ...
        <div id="content" >
            ...
            <nav class="navbar navbar-expand-lg " style="background-color:#22395D;border-radius:10px;width:99.5%;margin-left:3px" onload="Page_Load">
                <div class="container-fluid">
                    ...
                    <button type="button" id="sidebarCollapse" style="background-color:#22395D;border-style:none;"  class="btn btn-info">
                        ...
                        <span style="color:white" ><img src="img/menu.png" height="50" width="80"/>MENU</span>
                    </button>
            ...
            <center>
                <h1>UPDATE RANK</h1>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [cid],[appno], [c_fname], [c_mname], [c_lname], [c_course], [c_courseyear], [c_batch] FROM [cadet] where c_status='APPROVED'"></asp:SqlDataSource>
             <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" DataKeyNames="cid" DataSourceID="SqlDataSource1" CellSpacing="1" GridLines="Both" HorizontalAlign="Center">
                <Columns>
                    ...
                    <asp:BoundField DataField="c_fname" HeaderText="CADET's FIRST NAME" SortExpression="c_fname" />
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <a  class="btn btn-success" href='Rankholders1.aspx?id=<%#Eval("cid")%>&fname=<%#Eval("c_fname")%>&mname=<%#Eval("c_mname")%>&lname=<%#Eval("c_lname")%>&course=<%#Eval("c_course")%>&c_courseyear=<%#Eval("c_courseyear")%>&batch=<%#Eval("c_batch")%>' >Update Rank</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <FooterStyle BackColor="#C6C3C6" ForeColor="Black" />
                <HeaderStyle BackColor="#4A3C8C" Font-Bold="True" ForeColor="#E7E7FF" BorderStyle="Solid" HorizontalAlign="Center" />
                <PagerStyle BackColor="#C6C3C6" ForeColor="Black" HorizontalAlign="Right" />
                <RowStyle ForeColor="Black" BackColor="#DEDFDE" HorizontalAlign="Center" />
