...
<html lang="en">
<head>
<title>NationalCadetCorps-2022</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-white w3-animate-left w3-card" style=" background-color:cadetblue;z-index:3;width:320px;" id="mySidebar">
  ...
  class="w3-bar-item w3-button w3-hide-large w3-large">Close <i class="fa fa-remove"></i></a>
    ...
    <img  src="Icons/camping-tent.png" height="27" width="27" /><i class=" w3-margin-right"></i> Camps
  </a>
  ...
  <ul class="dropdown-menu dropdown-menu-xxl-end" aria-labelledby="dropdownMenuLink1">
    ...
    <%-- parade --%>
     ...
     <img  src="Icons/parade.png" height="25" width="25" /><i class=" w3-margin-right"></i> Parade
  </a>
  ...
  <ul class="dropdown-menu dropdown-menu-xxl-end" aria-labelledby="dropdownMenuLink2">
    ...
    <a class="w3-bar-item w3-button w3-padding btn dropdown-toggle  dropdown mt-2" style="font-size:larger" href="#" role="button" id="dropdownMenuLink6" data-bs-toggle="dropdown" aria-expanded="false">
     <img  src="Icons/rank.png" height="25" width="25" /><i class="fa-fw w3-margin-right"></i> Rank Holders
  </a>
...
<a class="w3-bar-item w3-button w3-padding btn dropdown-toggle  dropdown mt-2" href="#" style="font-size:larger" role="button" id="dropdownMenuLink7" data-bs-toggle="dropdown" aria-expanded="false">
  ...
  <ul class="dropdown-menu dropdown-menu-xxl-end" aria-labelledby="dropdownMenuLink3">
   ...
   <%-- Key highlights --%>
<a href="keyhighlights.aspx" style="font-size:larger" class="w3-bar-item w3-button w3-padding mt-2"><img  src="Icons/keyhighlighta.png" height="25" width="25" /><i class=" w3-margin-right"></i> Key Highlights</a>
      <%-- Achievements --%>
    ...
    <a href="message.aspx" style="font-size:larger" class="w3-bar-item w3-button w3-padding mt-2"><img  src="Icons/message.png" height="25" width="25" /><i class="fa  w3-margin-right"></i> Announcements</a>
      

    <%-- Logout --%>
  <a href="adminlogin.aspx" style="font-size:larger" class="w3-bar-item w3-button w3-padding mt-2"> <img  src="Icons/logout.png" height="23" width="23" /><i class="w3-margin-right"></i> Log Out</a>
...
<div class="w3-row-padding w3-margin-bottom">
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-teal w3-padding-16">
        ...
        <div class="w3-clear"></div>
        <h6><asp:Label ID="Label4" runat="server" Font-Size="small" ></asp:Label> Participants</h6>
      </div>
    </div>
    <div class="w3-quarter">
