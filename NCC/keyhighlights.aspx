<%@ Page Language="C#" AutoEventWireup="true" CodeFile="keyhighlights.aspx.cs" Inherits="NCC_keyhighlights" %>
                ...
                <div class="col-md-5">
                    <asp:DetailsView style="margin-top:7rem;" BorderStyle="Solid" ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="id" DataSourceID="SqlDataSource1" Height="600px" Width="525px" AllowPaging="True" BorderColor="Gray" BorderWidth="5px" >
                        <Fields>
                            ...
                            <asp:TemplateField SortExpression="highlights">
                                <EditItemTemplate>
                                    <h1>EDIT KEY HIGHLIGHTS</h1>
                                    <hr />
                                    <asp:TextBox ID="TextBox1" TextMode="MultiLine" runat="server" Text='<%# Bind("highlights") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:TextBox ID="TextBox1" TextMode="MultiLine" runat="server" Text='<%# Bind("highlights") %>'></asp:TextBox>
                                </InsertItemTemplate>
                                <ItemTemplate>
                                    <h1>EDIT KEY HIGHLIGHTS</h1>
                                    <hr />
                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("highlights") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
...
<ControlStyle CssClass="btn btn-info"></ControlStyle>
  ...
  <div class="card-footer text-muted">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [keyhighlights] WHERE [id] = @id" InsertCommand="INSERT INTO [keyhighlights] ([highlights]) VALUES (@highlights)" SelectCommand="SELECT [highlights], [id] FROM [keyhighlights]" UpdateCommand="UPDATE [keyhighlights] SET [highlights] = @highlights WHERE [id] = @id">
            <DeleteParameters>
