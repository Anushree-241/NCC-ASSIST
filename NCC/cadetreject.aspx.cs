...
public partial class NCC_cadetreject : System.Web.UI.Page
{
...

    {
        ...
        try
        {
            ...
            SqlCommand commandToCheckc_regid = new SqlCommand("select c_status  from cadet where c_status='REJECTED' and cid=" + "'" + pid + "'", con);
            con.Open();
            ...
            {
                Response.Write("<script>alert('CANDIDATE IS ALREADY REJECTED!!');window.location='cadetapproval.aspx';</script>");
            }
            else
            {
