<%@ Page Language="C#" AutoEventWireup="true" CodeFile="paradephoto.aspx.cs" Inherits="NCC_paradephoto" %>
...
<body>
    ...
    <div class="box">
        ...
        <h1>PARADE PHOTO GALLERY</h1>
        
        <div class="col-6">
    <label class="visually-hidden" for="inlineFormSelectPref">Select Parade Date </label>
            <asp:DropDownList ID="DropDownList1" AppendDataBoundItems="true"  CssClass="form-select" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="p_date" DataValueField="p_date">
                <asp:ListItem Selected="True" hidden="hidden">--SELECT PARADE DATE--</asp:ListItem>
  ...
  <div class="col-12">
     ...
     <!-- end of content-->  
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT p_date from parade"></asp:SqlDataSource>
	


         <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [a_id], [a_name] FROM [paradegallery] order by a_id desc"></asp:SqlDataSource>
    </form>
