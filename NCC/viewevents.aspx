<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewevents.aspx.cs" Inherits="NCC_viewevents" %>
...
<body>
  ...
  <img src="Uploades/Event photos/<%#Eval ("event_photos")%>" style="height:15rem;" class="card-img-top" alt="...">
  <div class="card-body">
    ...
    <p class="card-text"><%# Eval("event_desc") %></p>
      <h5>
          ...
          <asp:Label ID="Label13" runat="server" Style="margin-left:2rem;" Text='<%# Eval("event_date") %>'></asp:Label>
      </h5>
      <h5>
          <asp:Label ID="Label14" runat="server" Text="TIME"></asp:Label>
          <asp:Label ID="Label15" runat="server" Style="margin-left:2rem;" Text='<%# Eval("event_time") %>'></asp:Label>
      </h5>
      <h5>
