<%@ Page Language="C#" AutoEventWireup="true" CodeFile="campattendance.aspx.cs" EnableEventValidation="true" Inherits="NCC_attendance" %>
...
<body>
  ...
  <div class="col-sm-6">
    <div class="card" style="width:80rem;background-color:gainsboro" >
      <div class="card-body justify-content-center">
        ...
        <div class="row  mb-2 ">
    <label for="formGroupExampleInput" class="col-md-2 col-form-label">Camp Id</label>
    <div class="col-md-2">
 ...
 <label for="formGroupExampleInput"  class="col-md-2 col-form-label"> Date</label>
    ...
    <div class="col-md-2">
       <asp:Label ID="Label7" CssClass="form-control" runat="server"></asp:Label>
    </div>
            <label for="formGroupExampleInput" class="col-md-2 col-form-label">Camp Starting date</label>
...
<label for="formGroupExampleInput" class="col-md-2 col-form-label">Camp Ending date</label>
                        
    <div class="col-md-2">
        <asp:Label ID="Label3"  CssClass="form-control" runat="server"></asp:Label>
    </div>
<label for="formGroupExampleInput"  class="col-md-2 col-form-label">Camp Duration</label>
                        
    <div class="col-md-2">
       <asp:Label ID="Label4" CssClass="form-control" runat="server"></asp:Label>
    </div>
                        <label for="formGroupExampleInput"  class="col-md-2 col-form-label">Camp Type</label>
    ...
    <div class="col-md-2">
       <asp:Label ID="Label5" CssClass="form-control" runat="server"></asp:Label>
                    ...
                    <div class="row mb-2">
                        ...
                        <label for="formGroupExampleInput" class="col-md-2 col-form-label">Camp Name</label>
    ...
    <div class="col-md-6">
       <asp:Label ID="Label1"  CssClass="form-control" runat="server"></asp:Label>
          ...
          <hr />
        <p class="card-text">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Caption="CAMP ATTENDANCE " DataKeyNames="c_cid" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="3" GridLines="Vertical" HorizontalAlign="Center" CaptionAlign="Top" >
                <AlternatingRowStyle BackColor="#DCDCDC" />
            <Columns>
                <asp:BoundField DataField="c_cid" HeaderText="CADET ID" InsertVisible="False" ReadOnly="True" SortExpression="c_cid" />
                ...
                <asp:TemplateField HeaderText="ATTENDANCE STATUS">
                    <ItemTemplate>
                        ...
                        <asp:CheckBox  ForeColor="Green" Checked="true" Text="PRESENT" ID="CheckBox1" runat="server" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [c_cid],[appno], [c_fname], [c_lname], [c_course] FROM [campreg],[cadet] where campreg.c_cid= cadet.cid and campreg.camp_id = @camp_id">
            <SelectParameters>
                <asp:QueryStringParameter Name="camp_id" QueryStringField="id" />
            </SelectParameters>
            </asp:SqlDataSource>
