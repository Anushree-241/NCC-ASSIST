<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editevents.aspx.cs" Inherits="NCC_editevents" %>
    ...
    <!--sidenav-->
        ...
        <div id="content">
           ...
           <div>
            ...
            <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="event_id" DataSourceID="SqlDataSource1" Height="100px" Width="825px" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2">
                <EditRowStyle BackColor="#738A9C" Font-Bold="True" ForeColor="White" />
                <Fields>
                    <asp:TemplateField>
                        <ItemTemplate>
                             <h1 align="center">EDIT EVENT DETAILS</h1>
                            <br />
              <div class="row">
                  <div class="col-md-2">
    <label for="inputEmail4" class="form-label">EVENT ID</label>
     <asp:Label ID="Label1" runat="server" CssClass="form-control" Text='<%# Bind("event_id") %>'></asp:Label>

  </div>
                  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">EVENT NAME</label>
    <asp:Label ID="Label2" runat="server" CssClass="form-control" Text='<%# Bind("event_name") %>'></asp:Label>
  </div>

    <div class="col-3">
    <label for="inputAddress2" class="form-label">EVENT DATE</label>
    <asp:Label ID="Label4" runat="server" CssClass="form-control" Text='<%# Bind("event_date") %>'></asp:Label>
...
<div class="row">
    ...
    <asp:Label ID="Label3" runat="server" CssClass="form-control" Text='<%# Bind("event_desc") %>'></asp:Label>
  </div>
    <div class="col-md-3">
    <label for="inputCity" class="form-label">EVENT TIME</label>
    <asp:Label ID="Label5" runat="server" CssClass="form-control" Text='<%# Bind("event_time") %>'></asp:Label>
  </div>
...
<div class="row">
    ...
    <asp:Label ID="Label6" runat="server" CssClass="form-control" Text='<%# Bind("event_type") %>'></asp:Label>
  </div>
  <div class="col-md-6">
    <label for="inputZip" class="form-label">EVENT AMOUNT</label>
     <asp:Label ID="Label7" runat="server" CssClass="form-control" Text='<%# Bind("event_amount") %>'></asp:Label>
  </div>
                       ...
                       <EditItemTemplate>
                           ...
                           <div class="row">
                                <div class="col-md-2">
    <label for="inputEmail4" class="form-label">EVENT ID</label>
    <asp:Label ID="Label1" runat="server" CssClass="form-control" Text='<%# Eval("event_id") %>'></asp:Label>
  </div>
  <div class="col-md-5">
    <label for="inputPassword4" class="form-label">EVENT NAME</label><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ForeColor="Red" ErrorMessage="*"></asp:RequiredFieldValidator>
    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" Text='<%# Bind("event_name") %>'></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBox1" ForeColor="Red" ValidationExpression="[a-zA-Z0-9 ]*$" ErrorMessage="INVALID NAME!. This field should contain only numbers and letters"></asp:RegularExpressionValidator>
  </div>
                               <div class="col-3">
    <label for="inputAddress2" class="form-label">EVENT DATE</label><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox3" ForeColor="Red" ErrorMessage="*"></asp:RequiredFieldValidator>
    <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control"   Text='<%# Bind("event_date") %>'></asp:TextBox>
    </div>
                               <div class="col-md-1">
    <asp:ImageButton ID="ImageButton1" ImageUrl="~/NCC/img/planner.png" Style="margin-top:2rem;" CausesValidation= "false" Height="40" Width="40" runat="server"  OnClick="ImageButton1_Click" />
                 ...
                 <TodayDayStyle BackColor="#CCCC99" />
                           ...
                           <div class="row">
                               <div class="col-8">
    <label for="inputAddress" class="form-label">EVENT DESCRIPTION</label><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2" ForeColor="Red" ErrorMessage="*"></asp:RequiredFieldValidator>
    <asp:TextBox ID="TextBox2" runat="server" ReadOnly="true" CssClass="form-control" Text='<%# Bind("event_desc") %>'></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox2" ForeColor="Red" ValidationExpression="[a-zA-Z0-9_ ]*$"  ErrorMessage="INVALID DESCRIPTION!. Special characters are not allowed."></asp:RegularExpressionValidator>
  </div>
  
  <div class="col-md-3">
    <label for="inputCity" class="form-label">EVENT TIME</label><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox4" ForeColor="Red" ErrorMessage="*"></asp:RequiredFieldValidator>
    <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control"  Text='<%# Bind("event_time") %>'></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="TextBox4" ForeColor="Red" ValidationExpression="(([01]?[0-9]):([0-5][0-9]) ([AaPp][Mm]))"  ErrorMessage="INVALID FORMAT! Ex:11:00 AM"></asp:RegularExpressionValidator>
  </div>
                           </div>
  ...
  <div class="col-md-5">
    <label for="inputZip" class="form-label">EVENT TYPE</label><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBox6" ForeColor="Red" ErrorMessage="*"></asp:RequiredFieldValidator>
    <asp:TextBox ID="TextBox6" runat="server" ReadOnly="true" CssClass="form-control" Text='<%# Bind("event_type") %>'></asp:TextBox>
  </div>
                            
  <div class="col-md-6">
    <label for="inputZip" class="form-label">EVENT AMOUNT</label><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox7" ForeColor="Red" ErrorMessage="*"></asp:RequiredFieldValidator>
    <asp:TextBox ID="TextBox7" runat="server" ReadOnly="true" CssClass="form-control" Text='<%# Bind("event_amount") %>'></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="TextBox7" ForeColor="Red" ValidationExpression="^([0-9]|[1-9][0-9]|[1-9][0-9][0-9]|[1-9][0-9][0-9][0-9])$"  ErrorMessage="INVALID ENTRY!"></asp:RegularExpressionValidator>
  </div>
  </div>
                        ...
                        <InsertItemTemplate>
                            <div class="col-md-2">
    <label for="inputEmail4" class="form-label">EVENT ID</label>
    <asp:TextBox ID="TextBox1" runat="server"  CssClass="form-control" ReadOnly="true" Text='<%# Bind("event_id") %>'></asp:TextBox>
  </div>
  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">EVENT NAME</label><asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="TextBox2" ForeColor="Red" ErrorMessage="*"></asp:RequiredFieldValidator>
    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("event_name") %>'></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="TextBox2" ForeColor="Red" ValidationExpression="[a-zA-Z0-9 ]*$" ErrorMessage="INVALID NAME!. This field should contain only numbers and letters"></asp:RegularExpressionValidator>
  </div>
  <div class="col-10">
    <label for="inputAddress" class="form-label">EVENT DESCRIPTION</label><asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="TextBox3" ForeColor="Red" ErrorMessage="*"></asp:RequiredFieldValidator>
<asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" Text='<%# Bind("event_desc") %>'></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="TextBox3" ForeColor="Red" ValidationExpression="[a-zA-Z0-9_ ]*$"  ErrorMessage="INVALID DESCRIPTION!. Special characters are not allowed."></asp:RegularExpressionValidator>
  </div>
  <div class="col-3">
    <label for="inputAddress2" class="form-label">EVENT DATE</label><asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="TextBox4" ForeColor="Red" ErrorMessage="*"></asp:RequiredFieldValidator>
    <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control" Text='<%# Bind("event_date") %>'></asp:TextBox>
  </div>
  <div class="col-md-3">
    <label for="inputCity" class="form-label">EVENT TIME</label><asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="TextBox5" ForeColor="Red"  ErrorMessage="*"></asp:RequiredFieldValidator>
    <asp:TextBox ID="TextBox5" runat="server" CssClass="form-control" Text='<%# Bind("event_time") %>'></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ValidationExpression="(([01]?[0-9]):([0-5][0-9]) ([AaPp][Mm]))" ControlToValidate="TextBox5" ForeColor="Red" ErrorMessage="INVALID FORMAT! Ex:11:00 AM"></asp:RegularExpressionValidator>
  </div>
  
  <div class="col-md-3">
    <label for="inputZip" class="form-label">EVENT TYPE</label><asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="TextBox7" ForeColor="Red" ErrorMessage="*"></asp:RequiredFieldValidator>
    <asp:TextBox ID="TextBox7" runat="server" CssClass="form-control" Text='<%# Bind("event_type") %>'></asp:TextBox>
  </div>
                            
  
<div class="col-md-3">
    <label for="inputZip" class="form-label">EVENT AMOUNT</label><asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="TextBox12" ForeColor="Red" ErrorMessage="*"></asp:RequiredFieldValidator>
    <asp:TextBox ID="TextBox12" runat="server" CssClass="form-control" Text='<%# Bind("event_amount") %>'></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server" ControlToValidate="TextBox12" ForeColor="Red" ValidationExpression="^([0-9]|[1-9][0-9]|[1-9][0-9][0-9]|[1-9][0-9][0-9][0-9])$"  ErrorMessage="INVALID ENTRY!"></asp:RegularExpressionValidator>
  </div>
...
<ItemStyle ></ItemStyle>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [event] WHERE [event_id] = @event_id" InsertCommand="INSERT INTO [event] ([event_id], [event_name], [event_desc], [event_date], [event_time],  [event_photos], [event_type], [event_amount]) VALUES (@event_id,@event_name,@event_desc,@event_date,@event_time,@event_photos,@event_type,@event_amount)" SelectCommand="SELECT * FROM [event]" UpdateCommand="UPDATE [event] SET [event_name] = @event_name, [event_desc] = @event_desc, [event_date] = @event_date, [event_time] = @event_time, [event_photos] = @event_photos, [event_type] = @event_type, [event_amount] = @event_amount WHERE [event_id] = @event_id">
            <DeleteParameters>
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="event_photos" Type="String" />
                <asp:Parameter Name="event_type" Type="String" />
                <asp:Parameter Name="event_amount" Type="String" />
            </InsertParameters>
            <UpdateParameters>
                <asp:Parameter Name="event_name" Type="String" />
                <asp:Parameter Name="event_desc" Type="String" />
