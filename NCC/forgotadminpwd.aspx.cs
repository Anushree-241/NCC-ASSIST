...
public partial class NCC_forgotadminpwd : System.Web.UI.Page
{
    SqlConnection con;
    //SqlConnection con1;
        ...
        try
        {
           ...
           string s = "select * from adminlogin";
            ...
            if (ctr == 1)
            {
                ...
                {
                    s = "update adminlogin  set password=@p  where username=@username ";
                    SqlCommand cmd11 = new SqlCommand(s, con);
                    cmd11.Parameters.AddWithValue("@p", TextBox3.Text);
                    cmd11.Parameters.AddWithValue("@username", username);
                    con.Open();
