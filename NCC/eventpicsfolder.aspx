<%@ Page Language="C#" AutoEventWireup="true" CodeFile="eventpicsfolder.aspx.cs" Inherits="NCC_eventpicsfolder" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="FOLDER NAME" SortExpression="a_name">
                        ...
                        <ItemTemplate>
                            ...
                            <a id="lbl1" href="eventopenfolders.aspx?id=<%#Eval("a_id")%>" ><%#Eval("a_name")%></a>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [a_id], [a_name],[updatedat] FROM [eventgallery]"></asp:SqlDataSource>
