<%@ Page Language="C#" AutoEventWireup="true" CodeFile="paradeattendance.aspx.cs" Inherits="NCC_paradeattendance" %>
     ...
     <form id="form1" runat="server">
        ...
        <div id="content">
         ...
         <br />
            ...
            <div align="center" style="margin-left:8rem;">
  ...
  <div class="col-sm-6">
    <div class="card" style="width:80rem;background-color:gainsboro" >
      <div class="card-body justify-content-center">
        ...
        <div class="row  mb-2 ">
    <label for="formGroupExampleInput" class="col-md-2 col-form-label">Parade Id</label>
    <div class="col-md-2">
 ...
 <label for="formGroupExampleInput"  class="col-md-2 col-form-label"> Date</label>
    ...
    <div class="col-md-2">
       <asp:Label ID="Label7" CssClass="form-control" runat="server"></asp:Label>
            ...
            <label for="formGroupExampleInput" class="col-md-2 col-form-label">Parade date</label>
...
<label for="formGroupExampleInput" class="col-md-2 col-form-label">Parade Venue</label>
    ...
    <div class="col-md-6">
        <asp:Label ID="Label3" CssClass="form-control" runat="server"></asp:Label>
          ...
          <hr />
        <p class="card-text"> 
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="cid" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="3px" Caption="PARADE ATTENDANCE" CaptionAlign="Top" CellPadding="3">
            <Columns>
