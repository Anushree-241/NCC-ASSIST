<%@ Page Language="C#" AutoEventWireup="true" CodeFile="eventphoto.aspx.cs" Inherits="NCC_eventphoto" %>
...
<body>
    ...
    <div class="box">
        ...
        <div class="col-6">
    <label class="visually-hidden" for="inlineFormSelectPref">Select Event </label>
            <asp:DropDownList ID="DropDownList1"  AppendDataBoundItems="true" CssClass="form-select" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="event_name" DataValueField="event_name">
                <asp:ListItem Selected="True" hidden="hidden">--SELECT EVENT--</asp:ListItem>
  ...
  <div class="col-8 ">
    ...
    <div class="input-group">
      <asp:TextBox runat="server"  ReadOnly="true" class="form-control" ID="txt1"></asp:TextBox>
        ...
        <asp:Button ID="Button1" runat="server"  CssClass="btn btn-primary" Text="Create Folder" OnClick="Button1_Click" />
  ...
  <div class="col-12">
     ...
     <!-- end of content-->  
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT event_name from event"></asp:SqlDataSource>
         ...
         <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [a_id], [a_name] FROM [eventgallery] order by a_id desc"></asp:SqlDataSource>
    </form>
