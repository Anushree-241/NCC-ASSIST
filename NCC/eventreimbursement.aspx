<%@ Page Language="C#" AutoEventWireup="true" CodeFile="eventreimbursement.aspx.cs" Inherits="NCC_eventreimbursement" %>
...
<body>
        ...
        <div id="content" >
            ...
            <div class="card-body">
                ...
                <h1 align="center">EVENT REIMBURSEMENT</h1>
                <hr />
                <form class="row g-3" runat="server">
                    
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">Select Event Name</label>
      <asp:DropDownList AppendDataBoundItems="true" ID="DropDownList1" TabIndex="0" runat="server" CssClass="form-select" DataSourceID="SqlDataSource1" DataTextField="event_name" DataValueField="event_name" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"  >
          <asp:ListItem Selected="True">Select Event Name</asp:ListItem>
      </asp:DropDownList>
     <hr />
  </div>
...
<ul class="list-group list-group-horizontal" style="width:17rem;">
  ...
  <li class="list-group-item"><label for="inputCity" class="form-label">Event Name</label></li>
  <li class="list-group-item"><label for="inputCity" class="form-label">Event Date</label></li>
  <li class="list-group-item"><label for="inputCity" class="form-label">Event Amount</label></li>
</ul>
<ul class="list-group list-group-horizontal-sm">
...
<asp:Label ID="Label12" runat="server" Text=""></asp:Label>
  ...
  <div class="col-12">
      ...
      <center>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [event_name] FROM [event]"></asp:SqlDataSource>
	


             
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select  appno from cadet,eventatt,event where cadet.cid= eventatt.cadetid and event.event_id=eventatt.eventid and event.event_name = @eventname and eventatt.att_status='True' ">
            <SelectParameters>
