...
public partial class NCC_eventatt : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow row in GridView1.Rows)
        {
            ...
            dr["Event Name"] = GridView1.Rows[i].Cells[7].Text;
            ...
            if (i == GridView1.Rows.Count - 1)
            {
                ...
                dt.Rows.Add(dr1);
                dr1["Event Name"] = GridView1.FooterRow.Cells[7].Text;
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        pdfDocument.Close();
        Response.ContentType = "application/pdf";
        Response.AppendHeader("content-disposition", "attachment;filename=" + DropDownList1.Text + ".pdf");
