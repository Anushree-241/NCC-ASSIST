...
public partial class NCC_paradeatt : System.Web.UI.Page
{
    SqlConnection con;
    //SqlConnection con1;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        excel.Save(this.Response, "Parade Attendance.xlsx");
        ...
        //    dr["Cadet ID"] = GridView1.Rows[i].Cells[0].Text.ToString();
        //    dr["Register ID"] = GridView1.Rows[i].Cells[1].Text.ToString();
        //    dr["Cadet First Name"] = GridView1.Rows[i].Cells[2].Text.ToString();
        //    dr["Middle Name"] = GridView1.Rows[i].Cells[3].Text.ToString();
        //    dr["Last Name"] = GridView1.Rows[i].Cells[4].Text.ToString();
        //    dr["Course"] = GridView1.Rows[i].Cells[5].Text.ToString();
        //    dr["Course Year"] = GridView1.Rows[i].Cells[6].Text.ToString();
        //    dr["Parade Date"] = GridView1.Rows[i].Cells[7].Text.ToString();

        //    dr["Attendance Status"] = GridView1.Rows[i].Cells[8].Text.ToString();
        ...
        //        dt.Rows.Add(dr1);
        //        dr1["Parade Date"] = GridView1.FooterRow.Cells[7].Text.ToString();
        //        dr1["Attendance Status"] = GridView1.FooterRow.Cells[8].Text.ToString();
        //    }
        ...
        //Response.AddHeader("content-disposition", string.Format("attachment;filename=Parade" + DropDownList1.Text + ".xls", "AllColumn"));
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow row in GridView1.Rows)
        {
            ...
            dr["Parade Date"] = GridView1.Rows[i].Cells[7].Text;
            ...
            if (i == GridView1.Rows.Count - 1)
            {
                DataRow dr1 = dt.NewRow();
                dt.Rows.Add(dr1);
                dr1["Parade Date"] = GridView1.FooterRow.Cells[7].Text;
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Parade" + DropDownList1.Text + ".pdf");
        ...
        pdfDocument.Close();
        Response.ContentType = "application/pdf";
        Response.AppendHeader("content-disposition", "attachment;filename=parade" + DropDownList1.Text + ".pdf");
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        Response.Buffer = true;
        Response.Clear();
        Response.AddHeader("content-disposition", string.Format("attachment;filename=Parade" + DropDownList1.Text + ".docs", "AllColumn"));
    ...
    internal class BaseColor : iTextSharp.text.Color
    {
