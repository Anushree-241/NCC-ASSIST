...
public partial class NCC_paradephoto : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string s = "select concat ('Parade', '-' ,p_date)as concatname   from parade where p_date= " + "'" + DropDownList1.Text + "'";
        con.Open();
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        string s = "select p_id from parade where p_date= " + "'" + DropDownList1.Text + "'";
        con.Open();
        SqlCommand cmd1 = new SqlCommand(s, con);
        SqlDataReader reader;
        reader = cmd1.ExecuteReader();
        ...
        SqlCommand commandToCheckc_regid = new SqlCommand("select a_name from paradegallery where a_name=" + "'" + txt1.Text + "'", con);
        con.Open();
        ...
        if (!Directory.Exists(createfolder) && id != txt1.Text)
        {
            ...
            s = "insert into paradegallery values(@1,@2,@3,@4,@5)";
            //Response.Write(s);
            cmd1 = new SqlCommand(s, con);
            cmd1.Parameters.AddWithValue("@1", p_id);
            //camp_id == a_id
            cmd1.Parameters.AddWithValue("@2", p_id);
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (imgext == ".jpg" || imgext == ".png" || imgext == ".jpeg")
        {
            ...
            {
                string str = "insert into paradepictures (a_id,pic_loc) values(@1,@2)";
                con.Open();
                SqlCommand cmd = new SqlCommand(str, con);
                cmd.Parameters.AddWithValue("@1", p_id);
        ...
        Response.Redirect("paradepicsfolder.aspx");
